...
public class Q15820 {
	public static void main(String[] args) {
		...
		//0 => Accepted || 1=> Wrong Answer || 2=> Why Wrong!!!
		int Answer = 0; 
		...
		for(int i=0; i<S2; i++) {
			long A = sc.nextLong();
			long B = sc.nextLong();
			if(A != B && Answer == 0) Answer = 2;
		}
		
		if(Answer == 0) System.out.println("Accepted");
		else if(Answer == 1)System.out.println("Wrong Answer");
